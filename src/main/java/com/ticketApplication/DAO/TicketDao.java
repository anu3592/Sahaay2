...
public class TicketDao {
    ...
    public List<Ticket> getAllTicket(long id) {
       ...
       Query q = session.createNativeQuery("SELECT id, name, title, phone, category, address, problem_desc, status, created_at, assigned_to, user_id, encode(image, 'base64') as image from tickets where user_id= :id");
        q.setParameter("id", id);
